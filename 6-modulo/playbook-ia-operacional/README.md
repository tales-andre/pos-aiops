...
- [networkpolicy-sentinel](./devops/networkpolicy-sentinel/) — endurece um manifesto de NetworkPolicy permissivo em default-deny + allow least-privilege, com cadeia de geração + verificação (Chain-of-Verification) e critério de parada.
